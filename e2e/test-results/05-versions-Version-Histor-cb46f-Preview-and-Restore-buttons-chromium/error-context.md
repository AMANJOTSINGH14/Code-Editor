...
- Name: 05-versions.spec.js >> Version History >> saved version has Preview and Restore buttons
- Location: tests\05-versions.spec.js:85:3
...
Locator: getByText('Preview Version 1779847646221')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByText('Preview Version 1779847646221')
...
- banner:
  - button "← Back"
  - text: Version Doc 1779847646221 Room 6a1651e1d0c11261e36c1974
  - combobox:
...
- textbox "Version label (optional)": Preview Version 1779847646221
- button "Save"
- text: "Please wait before saving again Auto-save #3 less than a minute ago · Version Tester Auto"
- button "Preview"
- button "Restore"
- text: Listed Version 1779847646221 less than a minute ago · Version Tester Published
- button "Preview"
- button "Restore"
- text: "Auto-save #1 less than a minute ago · Version Tester Auto"
- button "Preview"
- button "Restore"
- alert
- alert
